...
modules: [
    ...
    , "fields": [
	    ...
	    {"inputParams": {"label": "attribute-prefix", "name": "attribute-prefix" } },
	    {"type": "url", "inputParams": {"label": "attribute-namespace", "name": "attribute-namespace" } },
    ...
    , "fields": [
	    ...
	    {"inputParams": {"label": "code-prefix", "name": "code-prefix" } },
	    {"type": "url", "inputParams": {"label": "code-namespace", "name": "code-namespace" } }
        ]
                }
    },
    {
    ...
    , "fields": [
	    ...
	    {"inputParams": {"label": "wrapper-prefix", "name": "wrapper-prefix" } },
	    {"type": "url", "inputParams": {"label": "wrapper-namespace", "name": "wrapper-namespace" } }
        ]
                }
    },
    {
    ...
    , "fields": [
	    ...
	    {"inputParams": {"label": "new-prefix", "name": "new-prefix" } },
	    {"type": "url", "inputParams": {"label": "new-namespace", "name": "new-namespace" } }
        ]
                }
    },
    {
